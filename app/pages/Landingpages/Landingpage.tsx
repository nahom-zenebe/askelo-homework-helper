...
import { FiArrowRight, FiCheck, FiBook, FiUpload, FiShare2, FiAward, FiPocket } from 'react-icons/fi';
...
export default function LandingPage() {
  const features = [
    {
      ...
      description: "Get clear, step-by-step explanations for any homework problem instantly."
    },
    {
      icon: <FiUpload />,
      title: "Upload Handwritten Work",
      description: "Take a photo of your handwritten or printed homework for instant help."
    },
    {
      icon: <FiAward />,
      title: "Multiple Subjects",
      description: "Supports Math, Science, English, History and more school subjects."
    },
    {
      icon: <FiCheck />,
      title: "Simple Answers",
      description: "No confusing jargon - just clear explanations you can understand."
    },
    {
      icon: <FiShare2 />,
  ...
  const testimonials = [
    {
      quote: "Askelo saved me hours of frustration on my math homework. The explanations actually make sense!",
      author: "Jamie Wilson",
      role: "High School Student"
    },
    {
      quote: "As a parent, I love how Askelo helps my child understand concepts instead of just giving answers.",
      author: "Maria Gonzalez",
      role: "Parent"
    },
    {
      quote: "I use Askelo to check my work and get alternative explanations. It's like having a tutor available 24/7.",
      author: "Tyler Chen",
  ...
  return (
    <div className="overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-300 mb-8 max-w-2xl drop-shadow">
                  Upload a photo or type your question. Get clear, step-by-step answers for Math, Science, English, and more. No jargon, just understanding.
                </p>
                  ...
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((item) => (
                      <div
                        ...
                        style={{
                          backgroundImage: `url(https://randomuser.me/api/portraits/${item % 2 === 0 ? 'women' : 'men'}/${item + 20}.jpg)`,
                      ...
                      <div className="mockup-window border border-blue-700 bg-blue-900">
                        <div className="flex justify-center bg-blue-800 p-10">
                          <div className="text-center">
                            ...
                            <h3 className="text-xl font-semibold mb-2">Askelo AI Helper</h3>
                            <p className="text-blue-300">Upload your homework for instant help</p>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <section className="py-20 bg-[#232B39]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white">How Askelo Helps You</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-gradient-to-br from-[#232B39] to-[#181C23]/80 rounded-xl p-8 hover:bg-[#181C23] transition-all border border-[#232B39] hover:border-blue-800/30 shadow-lg">
                ...
                <h3 className="text-xl font-semibold mb-3 text-white drop-shadow">{feature.title}</h3>
      ...
      <section className="py-20 bg-gradient-to-br from-[#181C23] to-[#232B39]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white">Simple As 1-2-3</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#232B39] rounded-xl p-8 border border-[#181C23] text-center shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">Upload Your Question</h3>
              <p className="text-gray-300">Take a photo or type your homework problem</p>
            </div>
            <div className="bg-[#232B39] rounded-xl p-8 border border-[#181C23] text-center shadow-lg">
              <div className="w-16 h-16 bg-gradient-to-br from-[#2563EB] to-[#1E40AF] rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold text-white shadow">
                2
              </div>
              <h3 className="text-xl font-semibold mb-3 text-white">Get AI Analysis</h3>
              <p className="text-gray-300">Our AI provides step-by-step explanations</p>
            </div>
            <div className="bg-[#232B39] rounded-xl p-8 border border-[#181C23] text-center shadow-lg">
              <div className="w-16 h-16 bg-gradient-to-br from-[#2563EB] to-[#1E40AF] rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold text-white shadow">
                3
              </div>
              <h3 className="text-xl font-semibold mb-3 text-white">Understand & Learn</h3>
              <p className="text-gray-300">Grasp concepts instead of just copying answers</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#181C23]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white">Powered By Advanced AI</h2>
            <p className="text-xl text-blue-300 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-[#232B39]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white">What Students & Parents Say</h2>
            <p className="text-xl text-blue-200 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gradient-to-br from-[#232B39] to-[#181C23]/80 rounded-xl p-8 border border-[#232B39] hover:border-blue-800/30 transition-all shadow-lg">
                <div className="flex items-center mb-6">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <svg key={star} className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="py-20 bg-gradient-to-br from-[#181C23] to-[#232B39]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-[#232B39]/60 to-[#181C23]/60 rounded-2xl p-12 text-center border border-[#232B39] shadow-xl">
            <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-white drop-shadow">Start Learning with Askelo – Free AI Homework Help</h2>
            <p className="text-lg text-gray-300 mb-8 max-w-3xl mx-auto">
              Join thousands of students getting better grades and actually understanding their homework.
            </p>
